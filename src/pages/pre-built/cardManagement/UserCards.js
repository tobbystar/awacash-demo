    ...
    <React.Fragment>
      ...
      <Content>
        <BlockHead size="sm">
          <BlockBetween>
            <BlockHeadContent>
              <BlockTitle page>User Cards</BlockTitle>
              <BlockDes className="text-soft">You have total {data.length} User Cards</BlockDes>
            </BlockHeadContent>
            <BlockHeadContent>
          ...
          <DataTable className="card-stretch">
            <DataTableBody>
              <DataTableHead className="nk-tb-item nk-tb-head">
                ...
                <DataTableRow size="">
                  <span className="sub-text">Card Type</span>
                </DataTableRow>
                <DataTableRow size="">
        ...
        <Modal isOpen={modal.edit} toggle={() => setModal({ edit: false })} className="modal-dialog-centered" size="lg">
          <ModalBody>
            ...
            <div className="p-2">
              <h5 className="title">User Cards</h5>
              <div className="mt-4">
                  ...
                  <Col md="6">
                    <FormGroup>
                      ...
                      <input
                        type="text"
                        name="lead"
                        defaultValue={formData.lead}
                        placeholder="Enter Client First First Name"
                        onChange={(e) => onInputChange(e)}
                        ref={register({
                          required: "This field is required",
                        })}
                        className="form-control"
                      />
                      {errors.lead && <span className="invalid">{errors.lead.message}</span>}
                    </FormGroup>
                  </Col>
                  <Col md="6">
                    <FormGroup>
                  ...
                  <Col md="6">
                    <FormGroup>
                      ...
                      <input
                        type="text"
                        name="card"
                        defaultValue={formData.card}
                        placeholder="Enter client Card Type"
                        onChange={(e) => onInputChange(e)}
                        ref={register({
                          required: "This field is required",
                        })}
                        className="form-control"
                      />
                      {errors.card && <span className="invalid">{errors.card.message}</span>}
                    </FormGroup>
                  </Col>
                  {/*<Col size="12">*/}
                  {/*  <FormGroup>*/}
