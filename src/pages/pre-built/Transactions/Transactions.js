                  ...
                  <thead>
                    <tr className="tb-tnx-head">
                      ...
                      <th className="tb-tnx-amount is-alt">
                        <span className="tb-tnx-total">Registration Ammount</span>
                        <span className="tb-tnx-status d-none d-md-inline-block">Ammount Status</span>
                      </th>
          ...
          <ModalBody>
            ...
            <div className="nk-tnx-details mt-sm-3">
              <Row className="gy-3">
                ...
                <Col lg={6}>
                  <span className="sub-text">Registration Ammount</span>
