    ...
    <React.Fragment>
      ...
      <Content>
        <BlockHead size="sm">
          <BlockBetween>
            <BlockHeadContent>
              <BlockTitle page>Loan Report</BlockTitle>
                        ...
                        <tr className="tb-odr-item" key={item.id}>
                          ...
                          <td className="tb-odr-action">
                            <div className="tb-odr-btns d-none d-sm-inline">
                              <Link to={`${process.env.PUBLIC_URL}/loan-report-print/${item.id}`} target="_blank">
                                <Button color="primary" size="sm" className="btn-icon btn-white btn-dim">
                                  <Icon name="printer-fill"></Icon>
                                </Button>
                              </Link>
                              <Link to={`${process.env.PUBLIC_URL}/loan-report-details/${item.id}`}>
