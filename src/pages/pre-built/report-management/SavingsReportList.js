                        ...
                        <tr className="tb-odr-item" key={item.id}>
                          <td className="tb-odr-info">
                                <span className="tb-odr-id">
                                  <Link to={`${process.env.PUBLIC_URL}/savings-report-details/${item.id}`}>
                                    #{item.orderId}
                                  </Link>
                                </span>
                          ...
                          <td className="tb-odr-action">
                            <div className="tb-odr-btns d-none d-sm-inline">
                              <Link to={`${process.env.PUBLIC_URL}/savings-report-print/${item.id}`} target="_blank">
...
export default SavingsReportList;
