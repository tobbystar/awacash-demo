        ...
        <Content>
          <BlockHead size="sm">
            <BlockBetween className="g-3">
              <BlockHeadContent>
                <BlockTitle page>
                  Applicant / <strong className="text-primary small">{user.name}</strong>
                </BlockTitle>
                <BlockDes className="text-soft">
                  <ul className="list-inline">
                    <li>
                      Loan Application ID: <span className="text-base">KID000844</span>
                    </li>
                    <li>
              ...
              <BlockHeadContent>
                <Link to={`${process.env.PUBLIC_URL}/loanRequests`}>
          ...
          <Block>
            <Row className="gy-5">
              <Col lg="5">
                <BlockHead>
                  <BlockHeadContent>
                    <BlockTitle tag="h5">Loan Application Info</BlockTitle>
