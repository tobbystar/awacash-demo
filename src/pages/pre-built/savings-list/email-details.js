            ...
            <BlockBetween>
              <BlockHeadContent>
                <BlockTitle tag="h3" page>
                  Customer / <strong className="text-primary small">{user.login}</strong>
                </BlockTitle>
                      ...
                      <div className="profile-ud-list">
                        ...
                        <div className="profile-ud-item">
                          <div className="profile-ud wider">
                            ...
                            <span className="profile-ud-value">{user.login}</span>
                          </div>
                        </div>
                        ...
                        <div className="profile-ud-item">
                          <div className="profile-ud wider">
                            ...
                            <span className="profile-ud-value">{user.login.split(" ")[1] || "Konichiwa"}</span>
                          </div>
                        </div>
                        <div className="profile-ud-item">
                          <div className="profile-ud wider">
                            <span className="profile-ud-label">Mobile Number</span>
                            <span className="profile-ud-value">{user.phone || "0893423234"}</span>
                          </div>
                        </div>
                        <div className="profile-ud-item">
                          <div className="profile-ud wider">
                            <span className="profile-ud-label">Email Address</span>
                            <span className="profile-ud-value">{user.login + "@gmail.com"}</span>
                          </div>
                        </div>
                      </div>
                    </Block>
                    ...
                    <Block>          
                       ...
                       <div className="bq-note-item" >
                            <div className="bq-note-text">
                              <p>{user.text || "Aproin at metus et dolor tincidunt feugiat eu id quam. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Aenean sollicitudin non nunc vel pharetra."}</p>
                            </div>
                            <div className="bq-note-meta">
                              <span className="bq-note-added">
                                Mailed on <span className="date">{user.date || "Apr 1 2022"}</span> at{" "}
                                <span className="time">{user.time || "10:57"} PM</span>
                              </span>
                              <span className="bq-note-sep sep">|</span>
                              <span className="bq-note-by">
                                By <span>{user.login}</span>
                              </span>
                ...
                <Sidebar toggleState={sideBar}>
                  <div className="card-inner">
                    <div className="user-card user-card-s2 mt-5 mt-xxl-0">
                      <UserAvatar className="lg" theme="primary" text={(user.name)} />
