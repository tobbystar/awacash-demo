          ...
          <ul className="data-list is-compact">
            ...
            <li className="data-item">
              <div className="data-col">
                ...
                <div className="data-value">Lagos</div>
              </div>
            </li>
            ...
            <li className="data-item">
              <div className="data-col">
                ...
                <div className="data-value">Nigeria</div>
              </div>
            </li>
            {/* <li className="data-item">
              <div className="data-col">
            ...
            <li className="data-item">
              <div className="data-col">
                ...
                <div className="data-value">Brother</div>
              </div>
            </li>
